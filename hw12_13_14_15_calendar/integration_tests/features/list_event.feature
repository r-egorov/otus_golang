Feature: list event
    ...
    Scenario: get list of events for the day
        When I send a "GET" request to "http://localhost:8080/events?datetime=2022-12-25T00:00:00Z&period=day"
    ...
    Scenario: get list of events for the week
        When I send a "GET" request to "http://localhost:8080/events?datetime=2022-12-19T00:00:00Z&period=week"
        Then the response code is 200
        And the response contains list of events
        And the events have IDs
        And events fields are as following:
    ...
    Scenario: get list of events for the month
        When I send a "GET" request to "http://localhost:8080/events?datetime=2022-12-01T00:00:00Z&period=month"
        Then the response code is 200
        And the response contains list of events
        And the events have IDs
        And events fields are as following:
    ...
    Scenario: invalid period
        When I send a "GET" request to "http://localhost:8080/events?datetime=2022-12-01T00:00:01Z&period=year"
        Then the response code is 400

    Scenario: invalid route
            When I send a "GET" request to "http://localhost:8080/whassup"
            Then the response code is 404

    Scenario: invalid method
            When I send a "PUT" request to "http://localhost:8080/events"
